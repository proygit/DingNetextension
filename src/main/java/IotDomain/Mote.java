...
public class Mote extends NetworkEntity {
    ...
    public Mote(Long DevEUI, Integer xPos, Integer yPos, Environment environment, Integer transmissionPower,
       ...
       super(DevEUI, xPos,yPos, environment,transmissionPower,SF,1.0, Double.valueOf("5655457383930465456"));
    ...
    public void setDataBackUp(LoraWanPacket packet) {
        this.dataBackUp = packet;
    }
    /**
